...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    static const char APP_MODE_NAME_MTK_WEBCAM[];
    //
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Scene Mode
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    //Video Callback
    static const char KEY_VIDEOCB_SIZE[];

	//water mark
	static const char KEY_PREVIEW_WATERMARK_TEXT_MODE[];
	static const char KEY_RECORD_WATERMARK_TEXT_MODE[];
    static const char KEY_PICTURE_WATERMARK_TEXT_MODE[];
    static const char KEY_VIDEOCB_WATERMARK_TEXT_MODE[];
	static const char KEY_WATERMARK_AREA[];
	static const char KEY_WATERMARK_TEXT[];
	static const char KEY_WATERMARK_TEXT_SIZE[];
	static const char KEY_WATERMARK_TEXT_X[];
	static const char KEY_WATERMARK_TEXT_Y[];
	static const char KEY_WATERMARK_TEXT_COLOR[];
	static const char KEY_WATERMARK_TIMESTAMP_FORMAT[];
	static const char KEY_PREVIEW_WATERMARK_IMG_MODE[];
	static const char KEY_RECORD_WATERMARK_IMG_MODE[];
    static const char KEY_PICTURE_WATERMARK_IMG_MODE[];
    static const char KEY_VIDEOCB_WATERMARK_IMG_MODE[];
    static const char KEY_WATERMARK_IMG_PATH[];
    static const char KEY_WATERMARK_IMG_AREA[];
    static const char KEY_WATERMARK_TEXT_MODE[];
    static const char KEY_WATERMARK_IMG_MODE[];

	//adas
	static const char KEY_ADAS_FORMAT[];
	static const char KEY_ADAS_SIZE[];

    // for live camera project to rotate the video
    static const char KEY_VIDEO_ROTATION[];

    // sensor type: main sensor, cvbs sensor, the 2nd cvbs, usb camera
    static const char KEY_SENSOR_FACING[];
