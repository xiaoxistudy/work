...
#ifndef CAMERA_SOURCE_TIME_LAPSE_SMP_H_

#define CAMERA_SOURCE_TIME_LAPSE_SMP_H_
...
class CameraSourceTimeLapseSmp : public CameraSourceSmp {
public:
    static CameraSourceTimeLapseSmp *CreateFromCamera(
    ...
    virtual ~CameraSourceTimeLapseSmp();
...
private:
    ...
    // Wrapper over CameraSourceSmp::signalBufferReturned() to implement quick stop.
    // It only handles the case when mLastReadBufferCopy is signalled. Otherwise
    // it calls the base class' function.
    virtual void signalBufferReturned(MediaBuffer* buffer);

    // Wrapper over CameraSourceSmp::read() to implement quick stop.
    ...
    // Then it calls the base CameraSourceSmp::dataCallbackTimestamp()
    ...
    CameraSourceTimeLapseSmp(const CameraSourceTimeLapseSmp &);
    CameraSourceTimeLapseSmp &operator=(const CameraSourceTimeLapseSmp &);
