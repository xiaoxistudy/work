...
const char MtkCameraParameters::APP_MODE_NAME_MTK_WEBCAM[]      = "MtkWebcam";
...
//
const char MtkCameraParameters::KEY_VIDEOCB_SIZE[] = "videocb-size";
...
//watermark
const char MtkCameraParameters::KEY_PREVIEW_WATERMARK_TEXT_MODE[] = "preview-watermark-text-mode";
const char MtkCameraParameters::KEY_RECORD_WATERMARK_TEXT_MODE[] = "record-watermark-text-mode";
const char MtkCameraParameters::KEY_PICTURE_WATERMARK_TEXT_MODE[] = "picture-watermark-text-mode";
const char MtkCameraParameters::KEY_VIDEOCB_WATERMARK_TEXT_MODE[] = "videocb-watermark-text-mode";
const char MtkCameraParameters::KEY_WATERMARK_AREA[] = "watermark-area";
const char MtkCameraParameters::KEY_WATERMARK_TEXT[] = "watermark-text";
const char MtkCameraParameters::KEY_WATERMARK_TEXT_SIZE[] = "watermark-text-size";
const char MtkCameraParameters::KEY_WATERMARK_TEXT_COLOR[] = "watermark-text-color";
const char MtkCameraParameters::KEY_WATERMARK_TEXT_X[] = "watermark-text-x";
const char MtkCameraParameters::KEY_WATERMARK_TEXT_Y[] = "watermark-text-y";
const char MtkCameraParameters::KEY_WATERMARK_TIMESTAMP_FORMAT[] = "watermark-timestamp-format";
const char MtkCameraParameters::KEY_PREVIEW_WATERMARK_IMG_MODE[] = "preview-watermark-img-mode";
const char MtkCameraParameters::KEY_RECORD_WATERMARK_IMG_MODE[] = "record-watermark-img-mode";
const char MtkCameraParameters::KEY_PICTURE_WATERMARK_IMG_MODE[] = "picture-watermark-img-mode";
const char MtkCameraParameters::KEY_VIDEOCB_WATERMARK_IMG_MODE[] = "videocb-watermark-img-mode";
const char MtkCameraParameters::KEY_WATERMARK_IMG_PATH[] = "watermark-img-path";
const char MtkCameraParameters::KEY_WATERMARK_IMG_AREA[] = "watermark-img-area";

const char MtkCameraParameters::KEY_WATERMARK_TEXT_MODE[] = "watermark-text-mode";
const char MtkCameraParameters::KEY_WATERMARK_IMG_MODE[] = "watermark-img-mode";

//ADAS
const char MtkCameraParameters::KEY_ADAS_FORMAT[] = "adas-format";
const char MtkCameraParameters::KEY_ADAS_SIZE[] = "adas-size";

const char MtkCameraParameters::KEY_VIDEO_ROTATION[] = "video-rotation";

const char MtkCameraParameters::KEY_SENSOR_FACING[] = "sensor-facing";
