...
public interface ITelephonyExt {
    ...
    /**
     * Apn setting is in manual mode or auto mode.
     * Default is auto mode, manual mode is customization from CT.
     * @return true if manual mode
     */
    boolean isManualApnMode();
    ...
    /**
     * Need data roaming customization or not.
     * @return true if need, OP09 will return true.
     */
    boolean needDataRoamingCustom();
}
