...
public class DefaultServiceStateExt implements IServiceStateExt {
    ...
    public int mapGsmSignalLevel(int asu, int gsmRscpQdbm) {
        ...
        //modified by chenpengfei to edit signal strength param start
        int dBm = mapGsmSignalDbm(gsmRscpQdbm,asu);
            if (gsmRscpQdbm < 0) {
            if(dBm >= -89){
        ...
        //modified by chenpengfei to edit signal strength param end
        return level;
    }
