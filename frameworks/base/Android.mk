...
# CARCORDER
LOCAL_SRC_FILES += \
	core/java/com/mediatek/carcorder/BinderHolder.java \
	core/java/com/mediatek/carcorder/CarcorderManager.java \
	core/java/com/mediatek/carcorder/CameraDevice.java \
	core/java/com/mediatek/carcorder/ADASInfo.java \

LOCAL_SRC_FILES += \
    core/java/com/mediatek/carcorder/ICarCamDeviceUser.aidl \
    core/java/com/mediatek/carcorder/ICarcorderEventListener.aidl \
    core/java/com/mediatek/carcorder/ICarcorderService.aidl \
    core/java/com/mediatek/carcorder/ICameraDeviceListener.aidl \
...
LOCAL_API_SRC_DIRS += ../../../../../frameworks/base/core/java/com/mediatek/hotknot/
LOCAL_API_SRC_DIRS += camera/effect/java
LOCAL_API_SRC_DIRS += camera/gesture/java
LOCAL_API_SRC_DIRS += media/imageTransform/java
LOCAL_API_SRC_DIRS += voiceextension/java
LOCAL_API_SRC_DIRS += ../../../../../frameworks/base/core/java/com/mediatek/sensorhub/
# ===== Used for MediaTek SDK, please do not modify without SDK group reviewing =====
...
# ============================================================
include $(CLEAR_VARS)
# API file paths. Must match the ones defined in device/mediatek/build/tasks/apicheck.mk
...
LOCAL_DROIDDOC_OPTIONS:= \
		...
		-removedApi $(MTK_INTERNAL_PLATFORM_REMOVED_API_FILE) \
		-nodocs
...
# Documentation.
# ============================================================
MTK_SRC_API_DIR := vendor/mediatek/proprietary/frameworks/api
...
LOCAL_DROIDDOC_CUSTOM_TEMPLATE_DIR:=vendor/mediatek/proprietary/frameworks/banyan/droiddoc/templates-mtk
...
LOCAL_JAVA_LIBRARIES := android.policy apache-xml bouncycastle conscrypt ethernet-service ims-common mediatek-common mediatek-framework mediatek-telephony-common mms-common okhttp services telephony-common voip-common wifi-service
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
