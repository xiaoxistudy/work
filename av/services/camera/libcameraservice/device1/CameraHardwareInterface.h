...
#define container_of(ptr, type, member) ({                      \
    ...
    static void __set_ANativeWindow(struct preview_stream_ops *w) {
        void *user = ((struct camera_preview_window *)w)->user;
        CameraHardwareInterface *__this =
            reinterpret_cast<CameraHardwareInterface *>(user);
        __this->mPreviewWindow = __this->mNewPreviewWindow;
    }
    ...
    void initHalPreviewWindow()
    {
        ...
        mHalPreviewWindow.nw.set_ANativeWindow = __set_ANativeWindow;
    }

    sp<ANativeWindow>        mPreviewWindow;
    sp<ANativeWindow>        mNewPreviewWindow;
